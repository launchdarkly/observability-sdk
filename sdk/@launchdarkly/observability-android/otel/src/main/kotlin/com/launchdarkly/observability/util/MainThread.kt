...
@com.launchdarkly.observability.InternalObservabilityApi
object AndroidLooperMainThreadExecutor : MainThreadExecutor {
 ...
 */
@com.launchdarkly.observability.InternalObservabilityApi
object MainThreadExecutorHolder {
    @Volatile
    ...
    fun set(executor: MainThreadExecutor) {
...
@com.launchdarkly.observability.InternalObservabilityApi
fun isMainThread(): Boolean = MainThreadExecutorHolder.current.isMainThread()
