...
import com.launchdarkly.otel.BuildConfig
...
val DEFAULT_DISTRO_ATTRIBUTES: Map<String, String> = distroAttributes("launchdarkly-observability-android")

/**
 * Distro attributes for [name]. The two products report different distro names so telemetry
 * identifies which one produced it, but share the version.
 */
@com.launchdarkly.observability.InternalObservabilityApi
fun distroAttributes(name: String): Map<String, String> = mapOf(
    "telemetry.distro.name" to name,
 ...
 */
@com.launchdarkly.observability.InternalObservabilityApi
fun readInjectedSymbolsId(context: Context): String? {
    return try {
 ...
 */
@com.launchdarkly.observability.InternalObservabilityApi
fun buildObservabilityResource(
    sdkKey: String,
