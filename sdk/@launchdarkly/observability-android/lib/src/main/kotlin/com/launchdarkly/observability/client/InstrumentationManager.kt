...
class InstrumentationManager(
    ...
    init {
        ...
        // TODO: this will be a list of instrumentations eventually
        val replayInstrumentation = ReplayInstrumentation()
        val loggerProvidersFromInstrumentations = listOf(replayInstrumentation)
        ...
        otelRUM = OpenTelemetryRum.builder(application, otelRumConfig)
            .addLoggerProviderCustomizer { sdkLoggerProviderBuilder, _ ->
                ...
                return@addLoggerProviderCustomizer if (options.disableLogs && options.disableErrorTracking) {
                    ...
                    configureLoggerProvider(sdkLoggerProviderBuilder, loggerProvidersFromInstrumentations)
                }
            }
            ...
            .addInstrumentation(replayInstrumentation)
            .build()
    ...
    private fun configureLoggerProvider(
        ...
        loggerProvidersFromInstrumentations: List<InstrumentationLoggerProvider>
    ): SdkLoggerProviderBuilder {
        ...
        for (p in loggerProvidersFromInstrumentations) {
            routingLogRecordProcessor.registerProcessor(p.getLoggerScopeName(), p.getLogRecordProcessor())
        }
